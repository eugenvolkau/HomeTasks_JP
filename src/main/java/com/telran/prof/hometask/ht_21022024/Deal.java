...
public class Deal {
   ...
   RankKards[] rank = RankKards.values();
   SuitCards[] suit = SuitCards.values();
    ArrayList<String> rankOfCards= new ArrayList<>();
    ArrayList<String> suitOfCards= new ArrayList<>();
    {
    ...
    final SuitCards[] suits = SuitCards.values();
    final RankKards[] rank = RankKards.values();
